    ...
    <main className="min-h-screen bg-slate-50 px-6 py-8 text-slate-950 sm:px-10 lg:px-12">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-6xl items-center">
        <div className="grid w-full gap-8 lg:grid-cols-[0.85fr_1fr] lg:items-center">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:max-w-xl">
                {roles.map((option) => (
                  <button
                    key={option.value}
                    type="button"
                    className={`rounded-2xl border px-4 py-4 text-left transition hover:border-sky-700 ${
                      role === option.value
          ...
          <section className="rounded-4xl border border-slate-200 bg-white p-8 shadow-sm shadow-slate-200/40 sm:p-10">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  {mode === "login"
                    ...
                    : "Add your details to create a new student or alumni account."}
                </p>
              </div>
